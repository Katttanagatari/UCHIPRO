const filterToggle = document.querySelector('.hero__filter');
const filterLinks = document.querySelector('.filter__section');
const filterClose = document.querySelector('.filter__close');
const heroTitleFilter = document.querySelector('.hero__title-filter');
...
filterToggle.addEventListener('click', () => {
    ...
    const filterHeight = filterLinks.offsetHeight + 42;
    heroTitleFilter.style.height = `${filterHeight}px`;
    if (window.innerWidth <= 800) {
        const heroContent = document.querySelector('.hero__content');

        if (filterLinks.classList.contains('open')) {
            heroContent.style.paddingBottom = '0';
        } else {
            heroContent.style.paddingBottom = '87px';
        }
    }
    clearCourses();
});
...
filterClose.addEventListener('click', () => {
    filterLinks.classList.remove('open');
    heroTitleFilter.style.height = '';
    postMethods();
});
                        ...
                        <div class="hero__layout course__footer">
                            ...
                            <div class="course__actions">
                                ...
                                <button class="clearbtn add-to-cart" data-id="${course.id}">
                                    <div class="hero__layout main__btn btn__add">
    ...
    const displayUniqueTags = () => {
        ...
        let visibleTagsCount = 4;
        if (window.innerWidth <= 800) {
            visibleTagsCount = uniqueTags.length;
        } 
